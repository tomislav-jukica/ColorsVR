...
IL_004d:
	{
		...
		L_10 = ActionBasedControllerManager_GetInputAction_mF25A30A4FBBFD14E885F679280E3A23369CCD751(L_9, NULL);
		V_0 = L_10;
...
IL_0089:
	{
		...
		L_18 = ActionBasedControllerManager_GetInputAction_mF25A30A4FBBFD14E885F679280E3A23369CCD751(L_17, NULL);
		V_1 = L_18;
...
IL_0036:
	{
		...
		L_5 = InputSystem_get_devices_m92D52284ABC0BCE6CF46CB98EB870F2AA3890BF8(NULL);
		V_3 = L_5;
...
IL_0047_1:
			{
				...
				bool L_10;
				L_10 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_9, _stringLiteralF35C02D0118C69B6ADE22DDE2F7B35FDD2B1AD7C, NULL);
				V_5 = L_10;
				bool L_11 = V_5;
				if (!L_11)
				{
...
IL_0099:
	{
		...
		String_t* L_13;
		L_13 = String_Format_m8C122B26BC5AA10E2550AECA16E57DAE10F07E30(_stringLiteral08922C02E680D90FAAB0862833A88225C5A1F397, __this, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		...
		InputDevices_add_deviceConnected_m78FF855F70C572E7B9BFD5A591E2C5B023AB8728(L_14, NULL);
...
IL_0016:
	{
		...
		bool L_5;
		L_5 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_4, _stringLiteralF35C02D0118C69B6ADE22DDE2F7B35FDD2B1AD7C, NULL);
		V_1 = L_5;
		bool L_6 = V_1;
		if (!L_6)
		{
...
IL_0071:
	{
		...
		String_t* L_14;
		L_14 = String_Format_m8C122B26BC5AA10E2550AECA16E57DAE10F07E30(_stringLiteral675D495E61C139628601D1F560A558803C58CB67, __this, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_LogWarning_m5C8299150E64600CBF5C92706AD610C21D0C0DC5(L_14, __this, NULL);
	}
...
IL_006d:
	...
	}
	{
		...
		L_22 = Vector3_ClampMagnitude_mDEF1E073986286F6EFA1552A5D0E1A0F6CBF4500_inline(L_20, L_21, NULL);
		V_3 = L_22;
	}
...
IL_0080:
	{
		...
		L_25 = float3_op_Implicit_mEFC9D4DC1F88125A32EAD98DDD519DDB1F146292(L_24, NULL);
		NullCheck(L_23);
...
IL_0095:
	...
	}
	{
		...
		L_30 = float3_op_Implicit_mEFC9D4DC1F88125A32EAD98DDD519DDB1F146292(L_29, NULL);
		NullCheck(L_28);
